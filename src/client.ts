...
import { Self, SelfRetrieveResponse } from './resources/self';
import {
  Task,
  TaskCreateParams,
  TaskCreateResponse,
...
import {
  ...
  WorkspaceMemberRetrieveResponse,
  WorkspaceMembers,
} from './resources/workspace-members';
import {
  Attribute,
  ...
  Attributes,
  InputValue,
} from './resources/attributes/attributes';
import {
  List,
  ListCreateParams,
  ListCreateResponse,
...
import {
  Meeting,
  MeetingFindOrCreateParams,
  MeetingFindOrCreateResponse,
  MeetingListParams,
  MeetingListResponse,
  MeetingRetrieveResponse,
  Meetings,
} from './resources/meetings/meetings';
import {
  Object,
  ObjectCreateParams,
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ATTIO_CRM_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ATTIO_CRM_LOG'] or 'warn' if it isn't set.
   */
...
export class AttioCRM {
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.attio.com`,
    };
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ATTIO_CRM_LOG'), "process.env['ATTIO_CRM_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.attio.com';
  }
  ...
  attributes: API.Attributes = new API.Attributes(this);
  lists: API.Lists = new API.Lists(this);
  workspaceMembers: API.WorkspaceMembers = new API.WorkspaceMembers(this);
...
export declare namespace AttioCRM {
  ...
  export { Self as Self, type SelfRetrieveResponse as SelfRetrieveResponse };
}
